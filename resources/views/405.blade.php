...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('static/admin/plugins/images/favicon.png')}}">
    ...
    <!-- Custom CSS -->
    <link href="{{asset('admins')}}" rel="stylesheet">
    <!-- color CSS -->
...
<section id="wrapper" class="error-page">
    <div class="error-box">
        <div class="error-body text-center">
            ...
            <a href="javascript:history.back(-1);" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back To</a> </div>
