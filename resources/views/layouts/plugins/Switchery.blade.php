@push('link')
    <!-- Switchery CSS -->
    <link href="{{admin_asset('bower_components/switchery/dist/switchery.min.css')}}" rel="stylesheet" />
@endpush
...
@push('script')
    <script src="{{admin_asset('bower_components/switchery/dist/switchery.min.js')}}"></script>
    <script>
        $(function () {
            // Switchery
