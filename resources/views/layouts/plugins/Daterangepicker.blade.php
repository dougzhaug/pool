...
@if(isset($style) && $style == 'btn')
    <button type="button" class="btn btn-default pull-{{$opens or 'left'}} date-range-btn" style="padding:6px 12px;">
...
@push('script')
    <!-- date-range-picker -->
    <script src="{{admin_asset('bower_components/moment/moment.js')}}"></script>
