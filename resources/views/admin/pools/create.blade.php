    ...
    <form class="form-horizontal" method="POST" action="{{route('pools.store')}}">
        ...
        <div class="box-body">
            ...
            <div class="form-group {{ $errors->has('score') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    <input id="score" name="score" class="form-control" value="{{ old('score') }}" placeholder="分值">
                    @if ($errors->has('score'))
                        <span class="help-block">
            ...
            <div class="form-group {{ $errors->has('answer_time') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    <input id="answer_time" name="answer_time" class="form-control" value="{{ old('answer_time') }}" placeholder="答题时间（秒）">
