...
@section('box')
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form class="form-horizontal" method="POST" action="{{route('pools.store')}}">
        ...
        <div class="box-body">
            ...
            <div class="form-group {{ $errors->has('sn') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    <input id="sn" name="sn" class="form-control" value="{{ old('sn') }}" placeholder="题号">
                    @if ($errors->has('sn'))
            ...
            <div class="form-group {{ $errors->has('question') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    <input id="question" type="text" name="question" class="form-control" value="{{ old('question') }}" placeholder="题目" required>
            ...
            <div class="form-group {{ $errors->has('answers') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    @include('layouts.plugins.CK-Editor',['name'=>'answers','placeholder'=>old('answers')])
            ...
            <div class="form-group {{ $errors->has('score') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    <input id="score" name="score" class="form-control" value="{{ old('score') ?? 10 }}" placeholder="分值">
                    @if ($errors->has('score'))
                        <span class="help-block">
            ...
            <div class="form-group {{ $errors->has('answer_time') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    <input id="answer_time" name="answer_time" class="form-control" value="{{ old('answer_time') ?? 120 }}" placeholder="答题时间（秒）">
